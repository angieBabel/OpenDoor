...
public class AlumnoActividad extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    //String insertURL= "http://192.168.43.64:8080/OpenDoor/insertAlumnoActividad.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alumno_actividad);

        nombre= (TextView)findViewById(R.id.textActividad);
    ...
    public void AlumAct(View v){
        StringRequest request = new StringRequest(Request.Method.POST, insertURL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parameters.put("nombreactividad",nombreactividad);
                parameters.put("salonactividad", salonactividad);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        AlumnoActividad.this.position = position;
